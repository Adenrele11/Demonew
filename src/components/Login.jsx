        ...
        <div class="w-full max-w-xs m-auto bg-white p-5">
          <header>
            <svg
              ...
              className="text-4xl m-auto text-neutral-900"
            >
              <title></title>
          ...
          <form>
            ...
            <div>
              <button
                ...
                type="submit"
                class="w-full  text-white bg-gradient-to-b from-green-600 to-neutral-800 hover:shadow-lg
                 font-bold py-2 px-4 mb-6 rounded cursor-pointer"
              >
                Login
              </button>
            </div>
