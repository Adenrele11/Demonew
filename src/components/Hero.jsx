    ...
    <>
      ...
      <div className=" flex justify-center items-center h-[80dvh] bg-gray-100 dark:bg-neutral-900 border-0">
        ...
        >
          ...
          <Link to={"/Stacks"} className="absolute top-24 right-8">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
          ...
          <Link to={"/Chatbot"} className="absolute bottom-24 right-8">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
          ...
          <Link to={"/Time"} className="absolute bottom-8">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
          ...
          <Link to={"/Time"} className="absolute bottom-24 left-8">
            <svg
              stroke="currentColor"
              fill="currentColor"
              stroke-width="0"
        ...
        <div
          className={`absolute w-24 h-24 bg-gradient-to-b from-green-600 to-neutral-800 flex justify-center items-center rounded-full cursor-pointer shadow-lg text-white text-3xl transition-transform duration-500 ${
            isOpen ? "rotate-45" : ""
          }`}
